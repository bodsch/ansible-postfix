...
class PostfixMaps(object):
    ...
    def run(self):
        ...
        for map_data in self.maps:
            ...
            if valid:
                ...
                if _changed:
                    if maps_type in ["btree", "cdb", "dbm", "fail", "hash", "lmdb", "sdbm"]:
    ...
    def _validate_map(self, map_data):
        ...
        postmap   = map_data.get("postmap", True)
        ...
        # self.__create_directory(os.path.join(self.dest, "maps"))
        #
        # checksum_file = os.path.join(self.cache_directory, "maps", maps_name)
        #
        # self.module.log(f"name: '{maps_name}' ({type(map_data)})")
        # self.module.log(f"  - type: '{maps_type}'")
        # self.module.log(f"  - data: '{maps_data}'")
        # self.module.log(f"  - file: '{maps_file}'")
        # self.module.log(f"  - vars: '{maps_vars}'")
        # self.module.log(f"  - postmap: '{postmap}'")
        # self.module.log(f"  - checksum file '{checksum_file}'")
